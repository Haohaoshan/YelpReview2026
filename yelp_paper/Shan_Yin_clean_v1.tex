...
\centering
\includegraphics[width=0.8\textwidth,angle=-90]{fig_lr_shap_rank_distance_colored.png}
\end{figure}
...
\centering
\includegraphics[width=0.80\textwidth,angle=-90]{05_xgb_top_features_shap_dependence.png} 
\end{figure}
...
\centering
\includegraphics[width=0.80\textwidth,angle=-90]{feature_rank_overall_vs_groups_2x2_overlay.png}
\end{figure}
