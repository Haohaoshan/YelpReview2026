...
**Table 3.3: Readability Features**  
...
**Table 3.4: Sentiment Features**  
  
| Feature               | Description |
|-----------------------|----------------------------------------------------------------|
| sentiment_proxy | Heuristic polarity-based sentiment score |

**Table 3.5: Structural Features**  
...
*All summary statistics in Table 4.3 are computed on the full dataset (training + test), whereas the tables in subsequent sections report results using the held‑out test set only.*     
...
\begin{figure}[H]
\centering
{\large \textbf{Figure 4.1: Cross-Model Feature Rank Comparison}}\
...
\begin{figure}[H]
\centering
{\large \textbf{Figure 4.2:  XGB SHAP Dependence Plot}}\
...
\begin{figure}[H]
\centering
{\large \textbf{Figure 4.3:  Logistic Regression XBETA Plot}}\
...
\begin{figure}[H]
\centering
{\large \textbf{Figure 4.4:  Overall and Segmented Feature Ranks}}\vspace{-0.3em}
